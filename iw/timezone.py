...
class TimezoneWindow (InstallWindow):
	...
	self.timeZones = ((("-14", ""), ("Etc/GMT-14", "Etc/GMT-14")),
                          ...
                          (("-09", ""), ("Etc/GMT-09", "Etc/GMT-09")),
                          (("-08", "US Pacific"),  ("Etc/GMT-08", "America/Los_Angeles")),
                          (("-07", "US Mountain"), ("Etc/GMT-07", "America/Denver")),
                          (("-06", "US Central"),  ("Etc/GMT-06", "America/Chicago")),
                          (("-05", "US Eastern"),  ("Etc/GMT-05", "America/New_York")),
                          (("-04", ""), ("Etc/GMT-04", "Etc/GMT-04")),
                          (("-03", ""), ("Etc/GMT-03", "Etc/GMT-03")),
                          (("-02", ""), ("Etc/GMT-02", "Etc/GMT-02")),
                          (("-01", ""), ("Etc/GMT-01", "Etc/GMT-01")),
                          (("",       ""), ("Etc/GMT", "Etc/GMT")),
                          (("+01", ""), ("Etc/GMT+01", "Etc/GMT+01")),
                          (("+02", ""), ("Etc/GMT+02", "Etc/GMT+02")),
                          (("+03", ""), ("Etc/GMT+03", "Etc/GMT+03")),
                          (("+04", ""), ("Etc/GMT+04", "Etc/GMT+04")),
                          (("+05", ""), ("Etc/GMT+05", "Etc/GMT+05")),
                          (("+06", ""), ("Etc/GMT+06", "Etc/GMT+06")),
                          (("+07", ""), ("Etc/GMT+07", "Etc/GMT+07")),
                          (("+08", ""), ("Etc/GMT+08", "Etc/GMT+08")),
                          (("+09", ""), ("Etc/GMT+09", "Etc/GMT+09")),
                          (("+10", ""), ("Etc/GMT+10", "Etc/GMT+10")),
                          (("+11", ""), ("Etc/GMT+11", "Etc/GMT+11")),
                          (("+12", ""), ("Etc/GMT+12", "Etc/GMT+12")))                    
