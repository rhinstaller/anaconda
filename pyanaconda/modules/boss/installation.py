...
class RunInstallationTask(InstallationTask):
    ...
    def _prepare_configuration(self):
        ...
        finish_tasks = [CopyLogsTask(conf.target.system_root), SetContextsTask(conf.target.system_root)]
    ...
    def _prepare_installation(self):
        ...
        def run_configure_bootloader():
            task_proxies = self._install_manager.collect_configure_bootloader_tasks(payload.kernel_version_list)
