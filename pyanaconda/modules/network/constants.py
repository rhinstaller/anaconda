...
@unique
class NMConnectionType(Enum):
    """Type of a NM Connection."""

    WIFI = NM_CONNECTION_TYPE_WIFI
    ETHERNET = NM_CONNECTION_TYPE_ETHERNET
    VLAN = NM_CONNECTION_TYPE_VLAN
    BOND = NM_CONNECTION_TYPE_BOND
    TEAM = NM_CONNECTION_TYPE_TEAM
    BRIDGE = NM_CONNECTION_TYPE_BRIDGE
    INFINIBAND = NM_CONNECTION_TYPE_INFINIBAND
