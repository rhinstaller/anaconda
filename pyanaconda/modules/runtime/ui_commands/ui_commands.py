...
class UICommandsModule(KickstartBaseModule):
    ...
    def process_kickstart(self, data):
        ...
        self._displayMode = data.displaymode.displayMode
        self._displayMode_nonInteractive = data.displaymode.nonInteractive
        self._vnc_enabled = data.vnc.enabled
        self._vnc_password = data.vnc.password
