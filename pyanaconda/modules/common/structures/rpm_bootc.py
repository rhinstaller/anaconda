#
# DBus structures for the RPM Bootc data.
#
...
__all__ = ["RPMBootcConfigurationData", "RPMBootcContainerConfigurationData"]


class RPMBootcConfigurationData(DBusData):
    """Structure to hold RPM Bootc configuration."""
...
class RPMBootcContainerConfigurationData(DBusData):
    """Structure to hold RPM Bootc from container configuration."""
