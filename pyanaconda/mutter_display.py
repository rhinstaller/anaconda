...
class Monitor(object):
    ...
    def __init__(self, props):
        ...
        self.modes = list(map(lambda p: MonitorMode(p), props[1]))
...
class LogicalMonitor(object):
    ...
    def __init__(self, props):
        ...
        self.monitor_ids = list(map(lambda p: MonitorId(p), props[5]))
        self.properties = props[6]
...
class MutterDisplay(object):
    ...
    def set_resolution(self, res_str):
        ...
        monitors = list(map(lambda props: Monitor(props), monitor_props))
        logical_monitors = list(map(lambda props: LogicalMonitor(props), logical_monitor_props))
