...
from pykickstart.constants import AUTOPART_TYPE_LVM, CLEARPART_TYPE_NONE, CLEARPART_TYPE_LINUX, \
    CLEARPART_TYPE_ALL, CLEARPART_TYPE_LIST, NVDIMM_ACTION_USE, NVDIMM_ACTION_RECONFIGURE
