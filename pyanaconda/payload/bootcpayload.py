...
from pyanaconda.core.constants import PAYLOAD_TYPE_BOOTC, SOURCE_TYPE_FLATPAK
...
class BootcPayload(MigratedDBusPayload):
    """ A BootcPayload deploys a tree (possibly with layered packages)
