...
from pyanaconda.core.constants import PAYLOAD_TYPE_RPM_BOOTC, SOURCE_TYPE_FLATPAK
...
class RPMBootcPayload(MigratedDBusPayload):
    """ A RPMBootcPayload deploys a tree (possibly with layered packages)
