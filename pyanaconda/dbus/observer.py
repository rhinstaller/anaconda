...
class DBusObserver(object):
    ...
    observer = DBusObserver("org.freedesktop.NetworkManager", message_bus=SystemBus)
    ...
    def __init__(self, service_name, message_bus=DBus):
...
class DBusObjectObserver(DBusObserver):
    ...
    def __init__(self, service_name, object_path, message_bus=DBus):
        ...
        :param message_bus: a message bus
        """
        super().__init__(service_name, message_bus=message_bus)
        self._proxy = None
...
class DBusCachedObserver(DBusObjectObserver):
    ...
    def __init__(self, service_name, object_path, watched_interfaces=None, message_bus=DBus):
        ...
        :param message_bus: a message bus
        """
        super().__init__(service_name, object_path, message_bus=message_bus)
