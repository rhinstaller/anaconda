...
PARTITIONING_METHOD_AUTOMATIC = "AUTOMATIC"  # ks autopart or let gui do whatever it wants
PARTITIONING_METHOD_CUSTOM = "CUSTOM"  # more complicated kickstart
PARTITIONING_METHOD_MANUAL = "MANUAL"  # mount things, can happen from ui
PARTITIONING_METHOD_INTERACTIVE = "INTERACTIVE"  # done by user from ui
PARTITIONING_METHOD_BLIVET = "BLIVET"  # done by user from blivet-gui
