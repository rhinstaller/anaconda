...
from pyanaconda.ui.tui.spokes.askrd import AskRDSpoke
...
def ask_rd_question(anaconda, grd_server, message):
    ...
    if spoke.use_remote_desktop:
        ...
        grd_server.rdp_password = spoke.rdp_pasword
...
def setup_display(anaconda, options):
    ...
    grd_server = GRDServer(anaconda)  # The vnc Server object.
