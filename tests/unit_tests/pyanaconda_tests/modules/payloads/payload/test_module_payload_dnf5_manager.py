...
class DNFManagerTestCase(unittest.TestCase):
    ...
    def _download_packages(self, packages, progress):
        ...
        for name in packages:
            ...
            progress.last_time = 0
            progress.end(
                payload, libdnf5.repo.DownloadCallbacks.TransferStatus_SUCCESSFUL, "Message!"
            )
    ...
    def _download_packages_failed(self, packages, progress):
        ...
        for name in packages:
            ...
            progress.last_time = 0
            progress.end(payload, libdnf5.repo.DownloadCallbacks.TransferStatus_ERROR, "Message!")
