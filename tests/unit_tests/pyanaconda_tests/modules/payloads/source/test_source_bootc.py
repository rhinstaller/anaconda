...
class BootcSourceInterfaceTestCase(unittest.TestCase):
    ...
    def test_type(self):
        ...
        assert SOURCE_TYPE_BOOTC == self.interface.Type
    ...
    def test_configuration(self):
        ...
        data = {
            "stateroot": get_variant(Str, "fedora-atomic"),
            "sourceImgRef": get_variant(Str, "quay.io/rhinstaller/anaconda-rpm:main"),
            "targetImgRef": get_variant(Str, "quay.io/rhinstaller/anaconda-rpm:main")
        }
...
class BootcSourceTestCase(unittest.TestCase):
    ...
    def test_type(self):
        """Test the type property."""
        assert SourceType.BOOTC == self.module.type

    def test_network_required(self):
        """Test the network_required property."""
        assert self.module.network_required is False

        self.module.configuration.sourceImgRef = "file://my/path"
        assert self.module.network_required is False

        self.module.configuration.sourceImgRef = "http://my/path"
        assert self.module.network_required is False

        self.module.configuration.sourceImgRef = "quay.io/rhinstaller/anaconda-rpm:main"
    ...
    def test_repr(self):
        ...
        self.module.configuration.stateroot = "fedora-atomic"
        self.module.configuration.sourceImgRef = "quay.io/rhinstaller/anaconda-rpm:main"
        ...
        assert repr(self.module) == str(
            ...
            "sourceImgRef='quay.io/rhinstaller/anaconda-rpm:main'"
            ")"
        )
