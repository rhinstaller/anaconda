...
from pyanaconda.modules.network.ifcfg import get_dracut_arguments_from_ifcfg, IFCFG_DIR, \
    ...
    get_slaves_from_ifcfgs, get_kickstart_network_data
...
IFCFG_FILES_REAL_ALL_TYPES = [
    ...
    # FIXME parent ifcfg file shouldn't be needed
    ("ifcfg-ens35",
     """
     # Generated by dracut initrd
     NAME="ens35"
     ...
     ONBOOT=yes
     NETBOOT=yes
     UUID="643d1eb2-7ea9-4f18-a0a8-537af15ac45e"
     IPV6INIT=yes
     BOOTPROTO=dhcp
     TYPE=Ethernet
     """,
     """
     network  --bootproto=dhcp --device=ens35 --ipv6=auto
     """),
    ...
    ("ifcfg-ens37",
     ...
     ONBOOT=yes
     NETBOOT=yes
     UUID="b4d3af1e-7be2-4a46-9612-0b83d82ff320"
     IPV6INIT=yes
     BOOTPROTO=dhcp
     TYPE=Ethernet
     """,
     """
     network  --bootproto=dhcp --device=ens37 --ipv6=auto
     """),
...
class IfcfgFileTestCase(unittest.TestCase):
    ...
    def get_ifcfg_file_of_device_test(self):
        ...
        ifcfg = get_ifcfg_file_of_device(nm_client, "ens35", root_path=root_path)
        self.assertEqual(os.path.basename(ifcfg.path), "ifcfg-ens35")
        ...
        # Parent device is found
        ifcfg = get_ifcfg_file_of_device(nm_client, "ens37", root_path=root_path)
        self.assertEqual(os.path.basename(ifcfg.path), "ifcfg-ens37")
