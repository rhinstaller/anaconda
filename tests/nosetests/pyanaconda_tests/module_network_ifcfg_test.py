...
from pyanaconda.modules.network.ifcfg import IFCFG_DIR, IfcfgFile, \
    get_ifcfg_files_paths, get_ifcfg_file, get_slaves_from_ifcfgs, \
...
IFCFG_FILES_MORE_COVERAGE = [
    ...
    ("ifcfg-ens111",
     ...
     """,
     """
     network  --bootproto=static --device=ens5 --gateway=192.168.141.1 --ip=192.168.141.131 --mtu=512 --nameserver=192.168.154.3,10.216.106.3 --netmask=255.255.255.0 --onboot=off --ipv6=auto
     """),
    # IPV6ADDR
    ("ifcfg-ens112",
     """
     ...
     IPV6INIT=yes
     IPV6_AUTOCONF=no
     IPV6ADDR=2400:c980:0000:0002::3
     IPV6_DEFAULTGW=2400:c980:0000:0002::1
     NAME="System ens112"
     """,
     """
     network  --bootproto=dhcp --device=ens112 --ipv6=2400:c980:0000:0002::3 --ipv6gateway=2400:c980:0000:0002::1
     """),
    # IPV6ADDR - without IPV6_AUTOCONF set explicitly to "no" it is ignored
    ("ifcfg-ens113",
     """
     DEVICE=ens113
     TYPE=Ethernet
     ...
     """,
     """
     network  --bootproto=dhcp --device=ens113 --ipv6=auto
     """),
    # DHCPCLASS, DHCP_HOSTNAME, ETHTOOL_OPTS
    ("ifcfg-ens114",
     """
     # Generated by dracut initrd
     NAME="ens114"
     ...
     """,
     """
     network  --bootproto=dhcp --dhcpclass=my_class --device=ens114 --ethtool="autoneg off speed 100 duplex full" --hostname=my_dhcp_hostname --ipv6=auto
     """),
]
...
class IfcfgFileTestCase(unittest.TestCase):
    ...
    def get_kickstart_network_data_test(self):
        ...
        ifcfg_files_to_test = IFCFG_FILES_REAL_ALL_TYPES + IFCFG_FILES_MORE_COVERAGE
        self._dump_ifcfg_files(ifcfg_files_to_test)
        nm_client = Mock()

        for ifcfg_file_name, _ifcfg_content, expected_ks in ifcfg_files_to_test:
